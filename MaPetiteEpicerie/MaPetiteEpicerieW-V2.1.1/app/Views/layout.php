...
<!-- Lien Javascript pour la page mot de passe oublié nathalie ! -->
...
<!-- Lien Javascript function checkpassword christophe -->
<script type="text/javascript" src="<?= $this->assetUrl('js/checkpassword.js') ?>"></script>
	    ...
	    <div class="navbar-header" >
	      ...
	      <div class="col-md-8 col-md-offset-2">
			...
			<?php if (isset($_SESSION['user']['ID_util']))
			{
				...
				echo "<p class='username clearMsg'>Bienvenue ".$_SESSION['user']['prenom']." ".$_SESSION['user']['nom']." !</p>";
				?>
