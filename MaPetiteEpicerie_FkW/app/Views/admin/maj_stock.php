...
<?php $this->start('main_content') ?>
	...
	<div>
		...
		<table>
			<thead>
				<td style='width: 50px; border: solid 1px black; color: white; text-align: center'>Valider</td>
                <td style='width: 450px; border: solid 1px black; color: white; text-align: center'>Descriptif</td>
                <td style='width: 70px; border: solid 1px black; color: white; text-align: center'>Poids / volume</td>
                ...
                <td style='width: 150px; border: solid 1px black; color: white; text-align: center'>Prix</td>
                <td style='width: 150px; border: solid 1px black; color: white; text-align: center'>Nouveau</td>
                <td style='width: 150px; border: solid 1px black; color: white; text-align: center'>Promo</td>
                <td style='width: 150px; border: solid 1px black; color: white; text-align: center'>Stock</td>
            </thead>
