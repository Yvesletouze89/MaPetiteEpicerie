...
// RECUPERATION DONNEES INSCRIPTION ET LIEN FONCTION
    $("#m").on('change', verifCivilite); // bouton radio civilite monsieur madame
    $("#mme").on('change', verifCivilite); // bouton radio civilite monsieur madame
...
function verifCivilite(){
    civiliteM = $("#m").val();
    civiliteMme = $("#mme").val();
    if (civiliteM == "m" || civiliteMme == "mme"){
        validCivilite=1;
    }else{
        validCivilite=0;
    }
