...
*********************************************-->
				...
				<section  id="connexion" class="row connexion">
					<div class="col-xs-12">
						<div class="form-area"> 
						<div><p class="titrecategories">Déjà inscrit, je me connecte&nbsp;!</p></div> 
        					<form method="POST" role="form" id="formSubmit1">
...
<!-- ***************INPUT POUR La CIVILITE *************** -->
								<div class="form-group col-xs-12">
					    			...
					    			<p><input type="radio" id="m" name="civilite" value="m"/> Monsieur</p>
  									<p><input type="radio" id="mme" name="civilite" value="mme"/> Madame</p>
								</div>
